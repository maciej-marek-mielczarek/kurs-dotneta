...
namespace Doppelganger.Domain.Entity.Texts
{
    public class MenuTexts: TextsBase
    {
        private static Dictionary<Enum, string> _enDict =
            ...
            {
                {TextLists.MenuTexts.NewGame, "New Game"},
                {TextLists.MenuTexts.Instructions, "Instructions"},
                {TextLists.MenuTexts.Exit, "Exit"}
            };
        
        private static Dictionary<Enum, string> _plDict =
            new Dictionary<Enum, string>()
            {
                {TextLists.MenuTexts.NewGame, "Nowa Gra"},
                {TextLists.MenuTexts.Instructions, "Instrukcje"},
                {TextLists.MenuTexts.Exit, "Wyjście"}
            };
